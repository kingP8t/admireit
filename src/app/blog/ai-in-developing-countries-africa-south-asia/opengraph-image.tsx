...
export const alt =
  "Why Africa and South Asia Are the Next Frontiers for AI-Powered Businesses";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          >
            Why Africa & South Asia Are the Next Frontiers for AI-Powered
            Businesses
          </div>
          <div
            style={{
          ...
          >
            73% AI enthusiasm in India. 600% growth in Nigeria. The data is
            clear.
          </div>
        </div>
