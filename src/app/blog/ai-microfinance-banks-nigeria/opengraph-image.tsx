      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <div style={{ fontSize: "16px", color: "#A0A0A0", display: "flex" }}>
              9 min read
            </div>
          </div>
          <div
          ...
          >
            AI for Microfinance Banks in Nigeria
          </div>
          <div
            style={{
              fontSize: "22px",
          ...
          >
            Credit scoring, fraud detection, WhatsApp support and loan
            automation &mdash; the use cases, ROI and CBN compliance that
            matter.
          </div>
        </div>
