...
export const alt = "Outcome Based Development — AdmireTech";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ fontSize: "52px", fontWeight: 800, color: "#FFFFFF", lineHeight: 1.1, maxWidth: "800px" }}>Outcome Based Development</div>
          <div style={{ fontSize: "24px", color: "#A0A0A0", maxWidth: "700px", lineHeight: 1.4 }}>
            Pay for outcomes, not hours. Results-linked delivery with measurable ROI.
          </div>
        </div>
