...
export const alt = "Custom Development — AdmireTech";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ fontSize: "56px", fontWeight: 800, color: "#FFFFFF", lineHeight: 1.1, maxWidth: "800px" }}>Custom Development</div>
          <div style={{ fontSize: "24px", color: "#A0A0A0", maxWidth: "700px", lineHeight: 1.4 }}>
            Full-stack web and mobile applications with deep AI integration.
          </div>
        </div>
