...
export const alt = "AI Chatbots — AdmireTech";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ fontSize: "56px", fontWeight: 800, color: "#FFFFFF", lineHeight: 1.1, maxWidth: "800px" }}>AI Chatbots</div>
          <div style={{ fontSize: "24px", color: "#A0A0A0", maxWidth: "700px", lineHeight: 1.4 }}>
            Custom AI-powered chatbots for customer support, lead generation, and internal workflows.
          </div>
        </div>
