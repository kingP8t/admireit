...
export const alt = "Fractional AI & ML Developers — AdmireTech";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ fontSize: "50px", fontWeight: 800, color: "#FFFFFF", lineHeight: 1.1, maxWidth: "800px" }}>Hire Fractional AI & ML Developers</div>
          <div style={{ fontSize: "24px", color: "#A0A0A0", maxWidth: "700px", lineHeight: 1.4 }}>
            Top-tier AI engineers on demand. Scale without the overhead of full-time hires.
          </div>
        </div>
